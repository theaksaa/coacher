    ...
    try {
        ...
        if (user) {
            ...
            if(exercise) {
                ...
                var score1 = parseInt((parseFloat(exercise.timeRequired).toFixed(2) ** (exercise.difficulty / 10.0)) * 100, 10);
                var userscore = parseInt(user.score, 10);
                var score2 = userscore + score1;
                user.score = score2;
                await user.save();
